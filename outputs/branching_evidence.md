...
| J002 | fit 73% against a 60% bar | `scan_for_injection > check_hard_constraints > evaluate_fit > request_human_approval` | 4 |
...
| J005 | fit 76% against a 60% bar | `scan_for_injection > check_hard_constraints > evaluate_fit > request_human_approval` | 4 |
