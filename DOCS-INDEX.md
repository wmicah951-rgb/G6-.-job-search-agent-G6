...
| 6 | **G6_Job_Search_Agent_Submission.pdf** | The graded deliverable | The assignment write-up. Traces in it are generated by `scripts/export-traces.ts`, never typed by hand; rebuild with `python3 scripts/build-submission-pdf.py`. |
| 7 | **[README.md](README.md)** | Setting it up | Install, environment variables, running it locally, deploying. |
