...
| `detectLocationAmbiguity(jobText, preferencesText)` | Returns a clarification question when the posting is silent on work arrangement while the candidate requires remote/hybrid, else `null` |
